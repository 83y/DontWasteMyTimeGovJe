...
def main(dateToFind, waitTime, hook):
    ...
    while found == False:
        ...
        for span in available:
            ...
            newDate = splitDate[0]+"/"+month_number+"/"+splitDate[2]
    ...
    for date in range(len(availableDates)):
        ...
        if newDate < dateToFind:
            embed = DiscordEmbed(title="Test found")
            embed.set_author(name="Made by 83y#2552")
